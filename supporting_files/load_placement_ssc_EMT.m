function load_placement_ssc_EMT(mdl,data)
%
...
for ll = 1:numel(data.loads.Bus_No)
    ...
    h1a = find_system([model,'Bus_',num2str(data.loads.Bus_No(ll))]);
    ...
    if strcmp(typel(ll),'Y-I')
        ...
        h = add_block(['YconstI_snt/',num2str(sum(qq2)),'sscT'],[model,'L',num2str(data.loads.Bus_No(ll))]);
        
    elseif strcmp(typel(ll),'Y-Z')
        
        h = add_block(['YconstZ_snt/',num2str(sum(qq2)),'ssc'],[model,'L',num2str(data.loads.Bus_No(ll))]);
        
    elseif strcmp(typel(ll),'Y-PQ') || strcmp(typel(ll),'Y-PR') % The benchmark data has a typo for load 4 'Y-PR'
        
        h = add_block(['YconstPQ_snt/',num2str(sum(qq2)),'sscT'],[model,'L',num2str(data.loads.Bus_No(ll))]);
        
    elseif strcmp(typel(ll),'D-Z')
        
        h = add_block(['DconstZ_snt/',num2str(sum(qq2)),'ssc'],[model,'L',num2str(data.loads.Bus_No(ll))]);
    ...
    elseif strcmp(typel(ll),'D-PQ')
        ...
        h = add_block(['DconstPQ_snt/',num2str(sum(qq2)),'sscT'],[model,'L',num2str(data.loads.Bus_No(ll))]);
    ...
    elseif strcmp(typel(ll),'D-I')
        ...
        h = add_block(['DconstI_snt/',num2str(sum(qq2)),'sscT'],[model,'L',num2str(data.loads.Bus_No(ll))]);
